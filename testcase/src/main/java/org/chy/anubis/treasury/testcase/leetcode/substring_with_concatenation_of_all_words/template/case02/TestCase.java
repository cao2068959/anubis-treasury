package org.chy.anubis.treasury.testcase.leetcode.substring_with_concatenation_of_all_words.template.case02;
...
public class TestCase implements Exector<Algorithm> {
    ...
    public void run(Algorithm algorithm) {
        ...
        AssertUtils.assertCollection(result, "[6,9,12]", false);
