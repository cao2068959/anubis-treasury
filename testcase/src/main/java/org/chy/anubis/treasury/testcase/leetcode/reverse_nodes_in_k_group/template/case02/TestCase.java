package org.chy.anubis.treasury.testcase.leetcode.reverse_nodes_in_k_group.template.case02;
...
public class TestCase implements Exector<Algorithm> {
    ...
    public void run(Algorithm algorithm) {
        ...
        AssertUtils.assertListNode(result, ListNode.of(1, 2, 3, 4, 5, 6, 7, 8));
