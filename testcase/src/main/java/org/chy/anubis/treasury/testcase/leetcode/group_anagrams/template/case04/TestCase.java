package org.chy.anubis.treasury.testcase.leetcode.group_anagrams.template.case04;
...
public class TestCase implements Exector<Algorithm> {
    ...
    public void run(Algorithm algorithm) {
        String[] data = {"eat","tea","tan","ate","nat","bat","ac","bd","aac","bbd","aacc","bbdd","acc","bdd"};
        Logger.info("[字母异位词分组]测试的数据为: [" + ArrayUtils.toString(data, s -> s) + "]");
        List<List<String>> result = algorithm.groupAnagrams(data);
        AssertUtils.assertCollection(result, "[[\"bdd\"],[\"bat\"],[\"nat\",\"tan\"],[\"ac\"],[\"ate\",\"eat\",\"tea\"],[\"bd\"],[\"aac\"],[\"bbd\"],[\"aacc\"],[\"bbdd\"],[\"acc\"]]", true,
